...
class EditProduct extends StatefulWidget {
  ...
  final String beingImage1;
  final String beingImage2;
  final String beingImage3;
  final String beingpromocode;
  final String beingpromoprice;
  final String beingreference;
...
class _EditProductState extends State<EditProduct> {
  ...
  void initState() {
    ...
    productDesController.text = widget.productDescription;
    if (widget.beingpromocode.isNotEmpty) {
      promocode.add(widget.beingpromocode);
      promoprice.add(widget.beingpromoprice);
    }
  }
  ...
  void validateAndUpload(String username, String uid, String categoryId) async {
    var id = Uuid().v1();
    try {
      if (_categorySelectedValue != null) {
        if (units != null || customUnitController.text.isNotEmpty) {
          if (_formKey.currentState.validate()) {
            ...
            sl.get<ProductService>().updateProduct(
                {
            ...
            setState(() => isLoading = false);
            Fluttertoast.showToast(msg: 'Check Your Form Details');
          }
        } else {
                    ...
                    : Column(
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              'Remember Star Marks (*) Always Importants And If Your Going To Edit This Detail Then Again You Need Wait For Approval!',
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              'Product Reference Number ${widget.beingreference}',
                              textAlign: TextAlign.center,
                              style: TextStyle(color: active, fontSize: 12),
                            ),
                          ),
